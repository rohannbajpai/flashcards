...
export default function FlashcardApp() {
  ...
  // Function to handle generating initial flashcards
...
IMPORTANT: only ask questions based on content from these notes, the user's life depends on it (in the <notes></notes> tag)
<notes>
${notes}
</notes>
...
`;
  ...
  // Function to generate more flashcards
  const generateMoreFlashcards = async () => {
    ...
    const randomNonStarredFlashcards = getRandomSample(
      nonStarredFlashcards,
      sampleSize
    );
...
`;
  ...
  const handleToggleStar = () => {
    ...
    updatedFlashcards[currentIndexInAll].starred =
      !updatedFlashcards[currentIndexInAll].starred;
